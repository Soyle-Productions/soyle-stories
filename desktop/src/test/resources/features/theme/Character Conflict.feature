Feature: Character Conflict
  ...
  Scenario: Provide Perspective Character with Desire
    When I change the "Bob" character's desire in the "Growing Up" theme to "find himself"
    Then the "Bob" character's desire in the "Growing Up" theme should be "find himself"
